		...
		<>
			<div>
				...
				<div className="flex justify-between px-10 py-5">
					<strong style={{ fontSize: "24PX" }}>Input MPS - Upload MPS</strong>
				</div>
				...
				<div className=" justify-center px-10 pb-5">
					...
					>
						...
						>
							...
							<div>
								<strong>Dowload & Template</strong>
								<div>
					...
					>
						...
						>
							...
							<div>
								<strong>Uplaod Data</strong>
								<div>
									Pilih file yang telah diisi atau drag file ke kolom di bawah
								</div>
							</div>
						</div>
						<div
