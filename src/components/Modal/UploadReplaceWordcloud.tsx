// import { doUploadReplaceWordcloud } from "";
import {
	Button,
	DatePicker,
	DatePickerProps,
...
interface UploadReplaceWordcloudProps {
	show: boolean;
	clickOk: () => void;
	clickCancel: () => void;
...
export default function UploadReplaceWordcloud(
	props: UploadReplaceWordcloudProps
) {
	...
	return (
		<>
			<Modal
				centered={true}
				width={1080}
				title="Upload Wordcloud Replacement "
				open={props.show}
				onOk={props.clickOk}
