...
export default function AddMainHcDashboard(props: AddMainHcDashboardrops) {
	const { Option } = Select;
	...
	return (
		<>
			<Modal
				centered={true}
				width={640}
				title={<h2 style={{ fontSize: "18px" }}>Add Report</h2>}
				open={props.show}
				onOk={props.clickOk}
